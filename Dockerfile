...
FROM quay.io/wildfly/wildfly:34.0.1.Final-jdk17 as wildfly_builder
...
ARG DB_HOST=jdbc:postgresql://postgres:5432/vinhnima
ARG DB_NAME=vinhnima
...
COPY --from=builder /app/target/vinhnima.war $JBOSS_HOME/standalone/deployments/
